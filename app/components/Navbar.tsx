        ...
        <motion.ul
          ...
          <motion.li whileHover={{ scale: 1.05 }}>
            <button
              ...
              className="px-6 py-2 border-4 border-[#6c727f] rounded-full bg-black text-white 
              hover:bg-[#6c727f] hover:text-black transition">
              CONTACT
            </button>
          </motion.li>
        </motion.ul>
            ...
            >
              ...
              <motion.li whileHover={{ scale: 1.1 }}>
                <button
                  ...
                  className="px-8 py-3 border-4 border-[#6c727f] rounded-full bg-black
                   text-white hover:bg-[#6c727f] hover:text-black transition"
                >
                  CONTACT
                </button>
              </motion.li>
